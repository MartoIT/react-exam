            ...
            <div className="row">
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="destination-item position-relative overflow-hidden mb-2">
                        <img className="img-fluid" src="img/destination-1.jpg" alt="fluid"/>
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="destination-item position-relative overflow-hidden mb-2">
                        <img className="img-fluid" src="img/destination-2.jpg" alt="fluid"/>
                        <a className="destination-overlay text-white text-decoration-none" href="#/">
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="destination-item position-relative overflow-hidden mb-2">
                        <img className="img-fluid" src="img/destination-3.jpg" alt="fluid"/>
                        <a className="destination-overlay text-white text-decoration-none" href="#/">
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="destination-item position-relative overflow-hidden mb-2">
                        <img className="img-fluid" src="img/destination-4.jpg" alt="fluid"/>
                        <a className="destination-overlay text-white text-decoration-none" href="#/">
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="destination-item position-relative overflow-hidden mb-2">
                        <img className="img-fluid" src="img/destination-5.jpg" alt="fluid"/>
                        <a className="destination-overlay text-white text-decoration-none" href="#/">
                ...
                <div className="col-lg-4 col-md-6 mb-4">
                    <div className="destination-item position-relative overflow-hidden mb-2">
                        <img className="img-fluid" src="img/destination-6.jpg" alt="fluid"/>
                        <a className="destination-overlay text-white text-decoration-none" href="#/">
